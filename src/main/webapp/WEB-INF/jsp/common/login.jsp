...
<body class="back flex justify-center items-center">
  ...
  <div class="card-body">
    ...
    <form method="POST" action="dologin">
      <input  name="member_id"type="text" placeholder="아이디를 입력하세요" class="input input-bordered w-80 max-w-xs" />
      </br>
      </br>
      <input name="member_pwd" type="password" placeholder="비밀번호를 입력하세요" class="input input-bordered w-full max-w-xs" />
      </br>
      </br>
      <div class="p-2">
